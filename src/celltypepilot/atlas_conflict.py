        ...
        for j in range(i + 1, len(node_names)):
            ...
            for gene in pos_neg_overlap_ab:
                conflicts.append(ConflictRecord(
                    ...
                    cell_type_a=node_a,
                    cell_type_b=node_b,
                    severity="high" if info_a["parent"] == node_b or info_b["parent"] == node_a else "medium",
            ...
            if info_a["parent"] != node_b and info_b["parent"] != node_a and info_a["parent"] != info_b["parent"]:
